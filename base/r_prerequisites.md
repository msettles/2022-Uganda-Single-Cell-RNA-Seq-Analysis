...
If you don't have any experience with R (or it has been a while) working through the first part of the [Introduction to R for Bioinformatics](https://msettles.github.io/2022_February_Introduction_to_R_for_Bioinformatics/){:target="_blank"} course should give you a good foundation for this workshop. Those who are interested in running their own analyses may want to keep going through parts two and three, or even register for the introduction to R course.
