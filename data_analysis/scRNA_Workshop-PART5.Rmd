...
markers.comp <- FindMarkers(experiment.merged, ident.1 = c("A001-C-007_18", "A001-C-104_18"), ident.2= "B001-A-301_18")

head(markers.comp)

experiment.subset <- subset(experiment.merged, samplecluster %in%  c( "A001-C-007_18", "A001-C-104_18", "B001-A-301_18" ))
